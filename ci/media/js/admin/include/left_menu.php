<div id="sidebar">					
	...
	?>				
					...
					<li><a href="#" title="Deal Manager" class="tooltip">Category Management</a>
						<ul>
							<li><a href="deal_category_manager.php?mode=add_cat" title="Add Category" class="tooltip">Add Deal/Coupan Category</a></li>
							<li><a href="deal_category_manager.php" title="Categories Manager" class="tooltip">Manage Deal/Coupan Category</a></li>
	...
	?>
					...
					<li><a href="#" title="Banner Manager" class="tooltip">General</a>
						<ul>
							...
							<li><a href="toptitle_manager.php" title="Top Titles" class="tooltip">Manage Top Titles</a></li>
