	...
	<div id="content">
		<div class="leftcol">
			<div class="latest_deal">
				<div class="left_top"><h1>Sub-Categories on PC Counter.net</h1></div>
				<div class="left_mid">
					<?php
						$items = 12;
						$page = 1;
						...
						$sql_category = "select * from ".MANAGE_E_CATEGORY." where is_active = 1 and cat_id = '".$_REQUEST['category']."' order by id desc ".$GLOBALS[sql_page]."";
						
						$sqlStrAux = "SELECT count(*) as total FROM ".MANAGE_E_CATEGORY." where is_active = 1 and cat_id = '".$_REQUEST['category']."'";
					...
					?>
									<div class="category_box">
										<div class="category_top">
                                            <ul>
                                              <li class="dc">
												  <a href="<?php echo SITE_URL; ?>deal_store_category.php?category=<?php echo $row_category['id']; ?>" style="display:block;"><?php echo $row_category['category_name']; ?></a>
											  </li>
                                           </ul>
										</div>
										<div class="category_mid" style="text-align:center;">
											<?php
												...
												{
											?>
												<?php /*?><a href="<?php echo SITE_URL; ?>deal_store_category.php?category=<?php echo $row_category['id']; ?>"><img src="images/noImage.jpg" alt="" width="147" height="133" border="0"/></a><?php */?>
											...
											<?php
												...
												{
											?>
												<?php /*?><a href="<?php echo SITE_URL; ?>deal_store_category.php?category=<?php echo $row_category['id']; ?>"><img src="<?php echo $row_category['cat_image']; ?>" alt="" width="157" height="133" border="0"/></a><?php */?>
												<a href="<?php echo SITE_URL; ?>deal_store_category.php?category=<?php echo $row_category['id']; ?>"><img src="images/noImage.jpg" alt="" width="147" height="133" border="0"/></a>
											<?php
												}
											?>
					...
					?>
								<div class="category_box">
									<span style="color:#FF0000;"><?php echo "NO SUB-CATEGORIES ARE THERE."; ?></span>
								</div>
					<?php
						}
					?>
