...
*/
 ...
 'db'=>"pccounter",  #default DB, optional
...
<div class="frm">
User name: <input type="hidden" name="v[user]" value="root"><br />
Password: <input type="hidden" name="v[pwd]" value="unified2010"><br />
MySQL host: <input type="hidden" name="v[host]" value="localhost"> port: <input type="text" name="v[port]" value="<?php echo $DB['port']?>" size="4"><br />
