...
<div id="maincontent">
	<div class="topbox">
		<div class="topbox_1">
			<h1>
				Most Popular Stores & Brands on PCcounter.net
			</h1>
			<p>
	...
	<div id="content">
		<div class="leftcol">
			<div class="latest_deal">
				<div class="left_top"><h1>Store & Brand</h1></div>
				<div class="left_mid">
					<?php
						$items = 12;
						$page = 1;
					...
					?>
									<div class="category_box">
										<div class="category_top">
											<h1><?php echo $row_store_and_brand['deal_source_name']; ?></h1>
										</div>
										<div class="category_mid">
											<?php
												...
												{
											?>
												<a href="<?php echo SITE_URL; ?>deal_store_category.php?brand=<?php echo $row_store_and_brand['deal_source_id']; ?>"><img src="images/noImage.jpg" alt="" width="147" height="133" border="0"/></a>
											<?php
												}
												else
												{
											?>
												<a href="<?php echo SITE_URL; ?>deal_store_category.php?brand=<?php echo $row_store_and_brand['deal_source_id']; ?>"><img src="<?php echo SITE_URL; ?>upload/<?php echo $row_store_and_brand['deal_source_logo_url']; ?>" alt="" width="157" height="133" border="0"/></a>
											<?php
												}
											?>
										</div>
