		...
		function get_pagenum_link($id){
				if(strpos($this->target,'?')===false)
						if($this->urlF)
								...
								return "$this->target?$this->parameterName=$id&brand=$_REQUEST[brand]&category=$_REQUEST[category]&subcategory=$_REQUEST[subcategory]&Search_for=$_REQUEST[Search_for]";
					else
						return "$this->target&$this->parameterName=$id&brand=$_REQUEST[brand]&category=$_REQUEST[category]&subcategory=$_REQUEST[subcategory]&Search_for=$_REQUEST[Search_for]";
			}
