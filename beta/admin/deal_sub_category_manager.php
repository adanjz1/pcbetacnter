...
elseif($_REQUEST['mode']=='update_cat'){
	...
	if($_REQUEST['cat_id']!=''){ 
		...
		if($num_check == 0){			
			if($image != "")
				mysql_query("insert into ".MANAGE_E_CATEGORY." (cat_id,category_name,cat_image,keyword,in_order,cate_update, title, title_name, title_desc, meta_tag, meta_content) values('".$_REQUEST['cat_id']. "','" .$_REQUEST['cat_name']."','".$image."','".$_REQUEST['keyword']."', '".$_REQUEST['in_order']."', '".date("Y-m-d H:i:s")."', '".$_REQUEST['title']."', '".$_REQUEST['title_name']."', '".$_REQUEST['title_desc']."', '".$_REQUEST['meta_tag']."', '".$_REQUEST['meta_content']."')");
			else
				mysql_query("insert into ".MANAGE_E_CATEGORY." (cat_id,category_name,keyword,in_order,cate_update, title, title_name, title_desc, meta_tag, meta_content) values('".$_REQUEST['cat_id']. "','" .$_REQUEST['cat_name']."','".$_REQUEST['keyword']."', '".$_REQUEST['in_order']."', '".date("Y-m-d H:i:s")."', '".$_REQUEST['title']."', '".$_REQUEST['title_name']."', '".$_REQUEST['title_desc']."', '".$_REQUEST['meta_tag']."', '".$_REQUEST['meta_content']."')");
			
			$msg = "Successfully Edit ".ucwords(str_replace("_"," ",$_REQUEST['cat_name']));
		}
		else{
			if($image != "")
				mysql_query("update ".MANAGE_E_CATEGORY." set cat_id = '".$_REQUEST['cat_id']."',category_name='".$_REQUEST['cat_name']."',cat_image='".$image."',keyword='".$_REQUEST['keyword']."', in_order='".$_REQUEST['in_order']."', title='".$_REQUEST['title']."', title_name='".$_REQUEST['title_name']."', title_desc='".$_REQUEST['title_desc']."', meta_tag='".$_REQUEST['meta_tag']."', meta_content='".$_REQUEST['meta_content']."' where id='".$_REQUEST['category_id']."'");
			else
				mysql_query("update ".MANAGE_E_CATEGORY." set cat_id = '".$_REQUEST['cat_id']."',category_name='".$_REQUEST['cat_name']."',keyword='".$_REQUEST['keyword']."', in_order='".$_REQUEST['in_order']."', title='".$_REQUEST['title']."', title_name='".$_REQUEST['title_name']."', title_desc='".$_REQUEST['title_desc']."', meta_tag='".$_REQUEST['meta_tag']."', meta_content='".$_REQUEST['meta_content']."' where id='".$_REQUEST['category_id']."'");
			
			$msg = "Successfully Edit ".ucwords(str_replace("_"," ",$_REQUEST['cat_name']));
		}
	}
	else{ 
		mysql_query("insert into ".MANAGE_E_CATEGORY." (category_name,cat_image,keyword,in_order,cate_update, title, title_name, title_desc, meta_tag, meta_content) values('".$_REQUEST['cat_name']."','".$image."','".$_REQUEST['keyword']."', '".$_REQUEST['in_order']."', '".date("Y-m-d H:i:s"). "', '".$_REQUEST['title']."', '".$_REQUEST['title_name']."', '".$_REQUEST['title_desc']."', '".$_REQUEST['meta_tag']."', '".$_REQUEST['meta_content']."')");
          ...
          <tr>
            ...
            <td width="71%" align="left"  style="padding-bottom:7px;">
              ...
              <select name="cat_id" id="cat_id" >
                ...
                <?php
				  	  $sql_category = "select * from ".MANAGE_E_CATEGORY." where is_active = 1 AND `cat_id`=0 and type='d' order by cate_update desc";
          ...
          <tr>
		    ...
		    <tr>
			 <td width="29%" align="left" class="cat_name">Content Name</td>
				<td width="71%" align="left"><input type="text" class="text" name="title_name" id="content_name[<?=$_REQUEST['title_name']?>]" value="<?=$row['title_name']?>" size="40"/>
				</td>
			 </tr>
			 <tr>
				<td width="29%" align="left" class="cat_name">Content Description</td>
				<td width="71%" align="left"><input type="text" class="text" name="title_desc" id="content_desc[<?=$_REQUEST['title_desc']?>]" value="<?=$row['title_desc']?>" size="40"/>
				</td>
			 </tr>
			 <tr>
