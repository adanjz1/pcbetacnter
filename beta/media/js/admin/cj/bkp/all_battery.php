...
$arr = array("http://1805267:4PCXJB9M@datatransfer.cj.com/datatransfer/files/1805267/outgoing/productcatalog/116371/All_Battery_com-Product_Catalog.xml.gz");
...
//	die;
	...
	for($i=0; $i<count($pr); $i++)
	{
		...
		$end_date = date("Y-m-d",strtotime($lastupdate));
