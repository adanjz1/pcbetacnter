...
<div class="pagination pagination-right">
    <div style="float:left; padding-top:6px;"><?php echo $lang->line('total'); ?>: <?php echo $this->totalRecord; ?> / <?php echo $this->totalPage; ?> <?php echo $lang->line('page'); ?></div>
        ...
        <?php if (!empty($this->results) && (int) $this->totalPage > 1) { ?>
            <?php if ($this->pageIndex > 1 && $this->totalRecord > 0) { ?>
                <li><a onclick="paginate(1);
                            return false;" href="#"><?php echo $lang->line('first'); ?></a></li>
                <li><a onclick="paginate(<?php echo $this->pageIndex - 1; ?>);
                            return false;" href="#">&laquo;</a></li>
                <?php } else { ?>
                <li class="disabled"><a onclick="return false;" href="#"><?php echo $lang->line('first'); ?></a></li>
            ...
            <?php for ($i = $f; $i <= $l; $i++) { ?>
                ...
                <li><a onclick="paginate(<?php echo $this->totalPage; ?>);
                            return false;" href="#"><?php echo $lang->line('last'); ?></a></li>
                <?php } else { ?>
                <li class="disabled"><a onclick="return false;" href="#">&raquo;</a></li>
                <li class="disabled"><a onclick="return false;" href="#"><?php echo $lang->line('last'); ?></a></li>
            <?php } ?>
        <?php } else { ?>
