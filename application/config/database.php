...
//$db['default']['password'] = '';
//$db['default']['database'] = 'pccounterci';
$db['default']['hostname'] = 'pccounterci.citaixw1vzuz.us-west-2.rds.amazonaws.com';
$db['default']['username'] = 'RDSroot';
$db['default']['password'] = 'pccounter136284';
$db['default']['database'] = 'pccounterci';
