...
elseif($_REQUEST['mode']=='update_cat'){
	...
	if($_REQUEST['category_id']!=''){
		if($image){
			mysql_query("update ".MANAGE_E_CATEGORY." set category_name='".$_REQUEST['cat_name']."',cat_image='".$image."', keyword='".$_REQUEST['keyword']."', in_order='".$_REQUEST['in_order']."', type='".$_REQUEST['type']."' where id='".$_REQUEST['category_id']."'");
		}else
			mysql_query("update ".MANAGE_E_CATEGORY." set category_name='".$_REQUEST['cat_name']."', keyword='".$_REQUEST['keyword']."', in_order='".$_REQUEST['in_order']."', type='".$_REQUEST['type']."' where id='".$_REQUEST['category_id']."'");
		$msg = "Successfully Edit ".ucwords(str_replace("_"," ",$_REQUEST['cat_name']));
	}
	else{
		mysql_query("insert into ".MANAGE_E_CATEGORY." (category_name,cat_image,keyword,in_order,cate_update,type) values('".$_REQUEST['cat_name']."','".$image."','".$_REQUEST['keyword']."', '".$_REQUEST['in_order']."', '".date("Y-m-d H:i:s")."', '".$_REQUEST['type']."')");
