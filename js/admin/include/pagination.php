...
<br/>
	...
	<table align="center" border="0" cellspacing="0" cellpadding="4" class="text_normal" style="padding-bottom:10px;">
	  ...
	  <tr>
		...
		<? ####### script to display no of pages #########
			...
			$displayPageLmt = 10; #holds no of page links to display
