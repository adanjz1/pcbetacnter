					...
					<div class="left_mid">
						<?php
							...
							elseif($_REQUEST['category'] != '')
							{
								...
								{
									$sql_deal = "select * from ".TABLE_PRODUCT." where deal_coupon = 'd' and deal_price >= '5' and cat_id = '".$_REQUEST['category']."' and sub_cat_id='".$_REQUEST['subcategory']."' and is_active = 1 order by deal_type desc, title desc, deal_price desc ".$GLOBALS[sql_page]."";
									$sqlStrAux = "SELECT count(*) as total FROM ".TABLE_PRODUCT." where deal_coupon = 'd' and deal_price >= '5' and cat_id = '".$_REQUEST['category']."' and sub_cat_id='".$_REQUEST['subcategory']."' and is_active = 1";
