				...
				<div class="latest_deal">
					...
					<div class="left_mid">
						<?php
							...
							$srch_str=mysql_real_escape_string($_REQUEST['Search_for']);
							if($srch_str!="")
							{
								$sql_deal = "select * from ".TABLE_PRODUCT." where deal_coupon = 'd' and deal_price >= '5' and title like '%$srch_str%' or description  like '%$srch_str%' and is_active = 1 order by title, deal_price desc ".$GLOBALS[sql_page]."";
								$sqlStrAux = "SELECT count(*) as total FROM ".TABLE_PRODUCT." where deal_coupon = 'd' and deal_price >= '5' and title like '%$srch_str%' or description like '%$srch_str%' and is_active = 1";
							}
